    ...
    $.extend(Plugin.prototype, {
        ...
        updateGradient: function () {
            ...
            if (t_color1 != this.color1 || t_color2 != this.color2) {
                ...
                for (i = 0; i < 4; i++) {
                   // $(this.element).css('background-image',"url('metatron.svg'), "+ this.prefixes[i] + 'linear-gradient(' + this.settings.angle + ', ' + this.color1 + ', ' + this.color2 + ')');
                    $(this.element).css('background-image', this.prefixes[i] + 'radial-gradient(' + this.color1 + ', #1C171E)');
